...
Eclipse BaSyx ist eine vom Fraunhofer-Institut für Experimentelles Software Engineering entwickelte Open-Source-Plattform für standardisierte digitale Zwillinge.
Der Fokus liegt auf einer einfachen Umsetzung einer Infrastruktur zur Erstellung und Verwaltung von Verwaltungsschalen (Asset Administration Shells, AAS).
Ein wesentlicher Vorteil von BaSyx ist sein Open-Source-Charakter: Die Software steht allen Interessierten frei zur Verfügung und erlaubt individuelle Anpassungen an spezifische Anforderungen.
Die Architektur basiert auf einer Vielzahl von Standardkomponenten (Off-the-Shelf), die alle als Docker-Container frei zugänglich sind.
Diese Komponenten folgen den Spezifikationen der Verwaltungsschale, insbesondere der Spezifikation Part 2: Application Programming Interfaces \cite{SpezifikationPart2}.
BaSyx lässt sich dadurch problemlos in bestehende Docker-Umgebungen integrieren.

Eine der wichtigsten Komponenten ist die Registry.
In ihr können neue AAS registriert und bereits vorhandene Verwaltungsschalen anhand ihrer eindeutigen Kennung gesucht werden.
