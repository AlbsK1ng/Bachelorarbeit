...
Alle Eigenschaften innerhalb dieser Vorlagen werden dabei in Verbindung mit dem ECLASS-Standard einheitlich semantisch beschrieben.
...
Die zur Prüfung notwendigen Informationen liefert in der Regel ein Token, das vom 
\linebreak
Identity Provider bereitgestellt wird. Die Spezifikation sieht hierfür die Nutzung sogenannter \acp{jwt} vor.
Die Attribute werden schließlich von dem Policy Service mit den dort hinterlegten Zugriffsrichtlinen abgeglichen und basierend darauf eine Zugriffsentscheidung getroffen.
