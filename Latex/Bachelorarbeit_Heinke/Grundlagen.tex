...
Allgemein bezeichnet der Begriff \acs{ki} eine Vielzahl von Methoden und Technologien, die es Computern ermöglichen, Aufgaben zu bewältigen, für die normalerweise menschliche Inteligenz erforderlich ist.
...
Im Gegensatz zu herkömmlichen Computerprogrammen wird kein Lösungsweg vorgegeben. 
Das Modell ist selbstständig in der Lage zu lernen. Es kann eigenständig Muster in den vorgegebenen Daten erkennen und anhand dieser eine bestimmmte Aufgabe ausführen  \cite{MLDefinition}.
...
Ein besonders vielversprechender Ansatz innerhalb des maschinellen Lernens ist das sogenannte Deep Learning.
