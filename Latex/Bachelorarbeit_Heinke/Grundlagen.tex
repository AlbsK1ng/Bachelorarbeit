\section{Grundlagen}
Das folgende Kapitel stellt die theoretischen und technologischen Grundlagen vor, die für das Verständnis und die Umsetzung dieser Arbeit notwendig sind.
...
Anschließend werden die Struktur und Funktion der Asset Administration Shell (AAS) sowie die Rolle des digitalen Produktpasses erläutert.
Den Abschluss bilden die technologischen Voraussetzungen für die praktische Umsetzung, darunter beispielsweise Eclipse BaSyx und der Kommunikationsstandard OPC UA.
...
Industrie 4.0 steht dabei für die vierte industrielle Revolution und beschreibt die umfassende dgitale Transformation industrieller Wertschöpfungsprozesse. 
...
Zur besser Einordnung von Industrie 4.0 ist ein Blick auf die vorangegangen industriellen Revolutionen hilfreich.
...
Ausgehend von dem deutschen Wirtschaftswunder in den sechziger Jahren des 20. Jahrhunderts enstand in den folgenden Jahrzehnten die dritte industrielle Revolution.
Diese zeichnet sich vor allem durch den Einsatz elektronischer Systeme sowie der Informations -und Kommunikationstechnologie zur Automatisierung aus und hält noch bis heute an.
...
Trotz der weitverbreiteten Nutzung des Begriffs Industrie 4.0 mangeld es in der Literatur und Forschung an einer einheitlichen Definition.
Vor diesem Hintergrund nimmt in Deutschland insbesondere die Plattform Industrie 4.0 \cite{plattform_i40} eine Schlüsselfunktion ein. 
Dabei handelt es sich um gemeinsame Initiative des Bundesministerium für Wirtschaft und Energie, Bundesministerium Forschung,Technologie und Raumfahrt, wichtiger Industrieverbänden (z.B. VDMA, Bitkom, ZVEI), Unternehmen, Forschungseinrichtungen und Gewerkschaften.
Die Plattform ist dabei maßgeblich an der inhaltlichen und strategischen Ausgestaltung der Industrie 4.0 beteiligt und leistet einen wichtigen Beitrag zur Begriffsdefinition. 
...
Die Definition legt den Fokus auf die durchgängige Digitalisierung und Vernetzung entlang der gesamten Wertschöpfungskette. 
Sie impliziert hiermit nicht nur technolgische Paradigmen wie autonome Steuerung, Echtzeitfähigkeit und intelligente, selbstorganissierende Strukturen, sondern auch tiefgreifende organisatorische Veränderungen über Unternehmensgrenzen hinweg.
Dadurch lassen sich nicht nur die Qualität, Effizienz und Transparenz von Produkten entlang des gesamten Lebenszykluses deutlich steigern, sondern auch der Ressourcenverbrauch, die Produktionskosten sowie der Energieeinsatz signifikant reduzieren.
Es wird also nicht nur die Wirtschaftlichkeit verbessert, sondern auch die ökologische Nachhaltigkeit gefördert.
