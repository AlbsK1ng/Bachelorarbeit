...
Dies wird durch die Verwendung von eindeutigen Identifikatoren wie einer URI (Uniform Resource Identifier) oder IRDI (International Registration Data Identifier) sichergestellt.
Für die Elemente innerhalb eines Submodells ist eine lokale Kennung ausreichend. Dies erfolgt in der Regel anhand einer idShort, die einen kurzen, aussagekräftigen Namen enthält.
Ein Submodell besteht immmer aus verschiedenen Submodellelementen. Sie können sowohl statische, als auch dynamische Modelle enthalten.
...
Die Zuordnung erfolgt über eine sogenannte semanticID.
...
Eine Typ 2-\acs{aas} hingegen wird von einer Laufzeitumgebung gehosted, wodurch ein direkter und dynamischen Zugriff auf ihre Inhalte ermöglicht. 
...
Dadurch wird ein automatisierter 
