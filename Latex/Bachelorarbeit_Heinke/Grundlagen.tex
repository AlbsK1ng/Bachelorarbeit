...
Der Begriff Industrie 4.0 wurde erstmals im Jahr 2011 im Rahmen eines von der deutschen Bundesregierung initiierten Zukunftsprojekts eingeführt, das auf die Förderung der Digitalisierung in der industriellen Fertigung abzielt.
...
Industrie 4.0 steht dabei für die vierte industrielle Revolution und beschreibt im Kern die Vernetzung und Digitalisierung industrieller Prozesse.
Im Zentrum steht die Integration der physischen mit der digitalen Welt durch den Einsatz cyber-physischer Systeme, die Maschinen, Produkte und Menschen intelligent miteinander verknüpfen
...
Aufbauend auf den vorangegangen industriellen Revolutionen strebt die vierte industrielle Revolution eine tiefrgreifende Transformation industrieller Produktionsprozesse an.
Im Zentrum steht die Vernetzung von Systemen, die über moderne Internettechnologien miteinander kommunizieren.
In Verbindung mit der Produktions -und Automatisierungstechnik entsteht so eine neue Ebene der Organisation und Steuerung industrieller Prozesse entlang der gesamten Wertschöpfungskette.
...
\cite{EinführungundUmsetzungI4.0} \cite{Industrie4.0ProduktionAutomatisierung}
...
Bereits seit den 1980er-Jahren wurden mit Ansätzen wie dem Computer Integrated Manufacturing (CIM) oder dem Lean Management Strategien entwickelt, die auf eine computerintegrierte und automatisierte Produktion abzielen und dabei den Menschen mehr in den Hintergrund rücken.
...
Erst mit dem technologischen Fortschritt, insbesondere der Einführung des Internetprotokolls V6 im Jahr 2012, wurde die Grundlage für eine globale, skalierbare Vernetzung von Maschinen, Produkten und Menschen über das Internet geschaffen.
...
Das IoT bildet somit die technologische Basis für die Industrie 4.0.
