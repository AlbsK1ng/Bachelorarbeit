...
Auf diese Weise schafft die \acs{aas} die Basis für die Umsetzung interoperabler digitaler Zwillinge.
...
Bestimmte Aspekte eines Assets werden gemäß der Spezifikation des Metamodells der \acs{aas} \cite{SpezifikationPart1} in Submodellen organisiert.
Diese fungieren als Container, die jeweils einen bestimmten Bereich des Assets abbilden, beispielsweise Typenschild, technische Stammdaten, Wartungsinformationen und Zustandswerte einer Maschine.  
Ihre Auswahl und Ausgestaltung ist domänenspezifisch und richtet sich nach dem jeweiligen Anwendungsfall.
Eine \acs{aas} kann beliebig viele Submodelle umfassen, die bei Bedarf auch erweitert werden können.
