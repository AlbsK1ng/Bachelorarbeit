...
Eine zentrale Herausforderung bei der Implementierung digitaler Zwillinge ist die fehlende Interoperabilität zwischen verschiedenen IT-Systemen.
Dadurch entstehen voneinander isolierte Datenbestände, die nicht systemübergreifend nutzbar sind.
Solche sogenannten Informationssilos entstehen bereits häufig innerhalb eines Unternehmens, wenn Daten und Informationen aus verschiedenen, nicht kompatiblen Systemen stammen.
Dies kann die Erstellung eines digitalen Zwillings erheblich erschweren, da die relevanten Informationen oft nicht in standardisierter Form vorliegen und zunächst aus unterschiedlichen Quellen bezogen werden müssen.
Solche isolierten Datenstrukturen finden sich jedoch nicht nur innerhalb eines Unternehmens sondern auch über Unternehmensgrenzen hinweg, beispielsweise in Lieferketten bei denen Akteure proprietäre Datenformate und Austauschprotokolle verwenden.
Ein digitaler Zwilling, der in einem Unternehmen A erstellt wurde, kann dadurch von einem Unternehmen B nicht ohne Weiteres intepretiert oder verwendet werden.
[citehttps://www.iiconsortium.org/pdf/Digital-Twin-and-Asset-Administration-Shell-Concepts-and-Application-Joint-Whitepaper.pdf]

Weiterer Absatz zu Herausforderungen
...
Eclipse BaSyx ist eine vom Fraunhofer-Institut für Experimentelles Software Engineering entwickelte Open-Source-Plattform für die Umsetzung von Industrie 4.0 - Anwendungen.
