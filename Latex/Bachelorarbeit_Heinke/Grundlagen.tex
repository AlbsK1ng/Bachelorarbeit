...
Wie auch alle anderen Komponenten stellen diese Repositories standardisierte Schnittstellen basierend auf der \acs{api}-Spezifikation zur Verfügung.
...
Im BaSyx-System ermöglicht ein Discovery Service die Verknüpfung physischer Assets mit ihren zugehörigen \acs{aas}.
...
Einträge in den Discovery Service müssen derzeit allerdings noch manuell über die \acs{api} (Application Programming Interface) vorgenommen werden.
