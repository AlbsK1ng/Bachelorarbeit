...
Bestimmte Aspekte eines Assets werden dabei in verschiedenen Submodellen verwaltet.
...
Der DPP 4.0 basiert dabei auf zwei etablierten Standards. Zum Einen das digitale Typenschild, und zum Anderen die Asset Administration Shell (siehe Kapitel~\nameref{chap:AAS}).
...
Während beispielsweise das digitale Typenschild oder der PCF öffentlich zugänglich sind, werden sensible Informationen wie technische Dokumentationen oder sicherheitsrelevante Details nur bestimmten autorisierten Gruppen zugänglich gemacht.
