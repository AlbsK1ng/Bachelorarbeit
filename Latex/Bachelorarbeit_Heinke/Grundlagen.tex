...
Allgemein bezeichnet der Begriff \acs{ki} eine Vielzahl von Methoden und Technologien, die es Computern ermöglichen, Aufgaben zu bewältigen, für die normalerweise menschliche Inteligenz erforderlich ist \cite{KIDefinition1}.
Dazu zählen insbesondere die Fähigkeit, aus Erfahrungen (Daten) zu lernen, eigenständig Problemlösungen zu entwickeln sowie Entscheidungen zu treffen \cite{KIDefinition2}.
...
Die Sicherheit wird dabei mithilfe eines attributbasierten Zugriffsmodells (Attribute Based Access Control (ABAC)) gewährleistet.
...
Eine schematische Darstellung des DPP 4.0 in Abbildung \ref{fig:dpp40} zu sehen.

\vspace{1em}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{Bilder/dpp_konzept.pdf}
    \caption{Konzept des DPP 4.0 (eigene Darstellung in Anlehnung an \cite{DPP40Bild})}
    \label{fig:dpp40}
\end{figure}
