...
Die nachfolgende Tabelle gibt einen Überblick über die initiale Auswahl dieser Submodelle sowie ihrer typischen Inhalte.
...
% Neben der dynamischen Aktualisierung einzelner Properties besteht auch die Möglichkeit, umfangreiche Zeitreihendaten in die \acs{aas} zu integrieren.
% Hierfür bietet das Submodel Template Time Series Data, das ebenfalls in einer Submodellspezifikation dokumentiert ist \cite{SpezifikationTimeSeriesData}, eine standardisierte Lösung.

Grundsätzlich lassen sich Zeitreihendaten auf unterschiedliche Weise in eine \acs{aas} einbinden.
