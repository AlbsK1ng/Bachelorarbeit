...
Dabei wird erläutert, wie eine \acs{aas} von Grund auf modelliert, schrittweise mit Inhalten gefüllt und abschließend in Form einer AASX-Datei gespeichert bzw. exportiert werden kann.  
...
Die wichtigsten davon sind in Abbildung~\ref{fig:IdentifikatorenAAS} dargestellt.
...
% \begin{figure}[htbp]
%     \centering
%     \includegraphics[width=0.8\textwidth]{Bilder/ModellierungAAS/Final/Identifikatoren.png}
%     \caption{Identifikatoren im Package Explorer}
...
\begin{figure}[htbp]
    \centering
    \includegraphics{Bilder/ModellierungAAS/V1/Identifikatore.png}
    \caption{Identifikatoren im Package Explorer}
    \label{fig:IdentifikatorenAAS}
\end{figure}
...
% \medskip
% \noindent
% \textbf{Relationship-Element}\\
% Dieses Element stellt eine Beziehung zwischen zwei anderen Submodellelementen her und beschreibt deren Verknüpfung innerhalb der Modellstruktur.

% \medskip
% \noindent
% \textbf{Reference-Element}\\
% Es verweist auf externe oder interne Ressourcen, wie Dateien, andere AAS-Elemente oder Submodelle, und ermöglicht so die Integration unterschiedlicher Datenquellen.
...
Dabei steht eine vordefinierte Eingabemaske zur Verfügung, die sich an der in Part 3a: Data Specification - IEC 61360 \cite{SpezifikationPart3a} definierte Vorlage orientiert.
...
\begin{figure}[htbp]
    ...
    \caption{Eingabemaske für den Inhalt einer \acs{cd}}
