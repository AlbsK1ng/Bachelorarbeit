...
Im Rahmen dieses Szenarios erhält die Rolle Groninger-Mitarbeiter vollständige Zugriffsrechte auf alle Submodelle des digitalen Produktpasses, während die Rolle Kunde ausschließlich Leserechte auf ausgewählte Submodelle (z.B. Typenschild oder Technische Daten) besitzt.  
...
Eine exemplarische \acs{rbac}-Konfiguration für die Rolle Groninger-Mitarbeiter ist in Listing~\ref{lst:groningerMitarbeiterRBAC} dargestellt.
