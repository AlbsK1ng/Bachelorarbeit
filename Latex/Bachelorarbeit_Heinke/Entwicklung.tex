...
Nach erfolgreicher Konfiguration muss das Modell trainiert werden.
...
Das fertig trainierte Modell kann anschließend zur Erkennung von Anomalien eingesetzt werden.
Analog zum Training werden erneut simulierte Temperaturverläufe verwendet, die jedoch gezielt Ausreißer bzw. Unregelmäßigkeiten enthalten.
Diese Testdaten sind strukturell identisch zu den Trainingsdaten, unterscheiden sich aber durch die eingefügten Anomalien.
