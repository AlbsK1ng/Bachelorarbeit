...
Ein Beispiel für eine entsprechende JSON-Konfiguration der Datenquelle ist in Listing~\ref{lst:jsonDatenquelle} für die Druck-Node dargestellt.
...
Auch diese Konfiguration erfolgt über eine separate JSON-Datei, in der der Endpoint des Submodells, der idShortPath der gewünschten Property sowie die verwendete API-Version definiert werden.
...
\begin{figure}[htbp]
    \centering
    % 0.88
    \includegraphics{Bilder/TimeSeries/MetadatenEigeneDarstellung.pdf}
...
\begin{figure}[htbp]
    \centering
    % 0.86
    \includegraphics{Bilder/TimeSeries/LinkedSegmentEigeneDarstellung.pdf}
    \caption{LinkedSegment-Konfiguration im Submodell Time Series Data}
