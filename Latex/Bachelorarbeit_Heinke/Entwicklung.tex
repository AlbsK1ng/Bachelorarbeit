...
Über einen sogenannten assetLink lässt sich diese logisch mit ihrem zugehörigen physischen Asset verknüpfen.
...
InfluxDB und Telegraf stehen beide als Docker-Container zur Verfügung und lassen sich so nahtlos in das bestehende BaSyx-System integrieren.
...
Dabei ist zu beachten, dass der entsprechende Port der InfluxDB nach außen freigegeben sein muss, da andernfalls kein Zugriff durch externe Anwendungen möglich ist.
...
Die manuelle Analyse dieser Daten ist jedoch sehr anspruchsvoll.
...
Um dem Autoencoder das Erkennen typischer Muster innerhalb dieser Daten zu ermöglichen, werden diese zunächst in Segmente unterteilt.
...
Im Folgenden wird gezeigt, wie eine \acs{aas} automatisiert erzeugt und bereitgestellt werden kann.  
...
Dieses wird durch ein Skript mit Daten befüllt, in eine vollständige \acs{aas}-Instanz überführt und abschließend in das Eclipse BaSyx-System integriert.
...
Das resultierende unternehmensspezifische Template erhält eine eigene 
\linebreak
semanticId, bleibt jedoch zugleich mit der semanticId des generischen Templates verknüpft.
